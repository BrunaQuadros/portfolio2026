...
export const faircado: FaircadoContent = {
  ...
  problem: {
    eyebrow: "PROBLEM",
    heading: "The MVP engaged. But didn't sell.",
    body:
      "Image searchers returned 3x more often than text searchers. Potential was there, but users scrolled results, favorited, opened product pages, and didn't buy. Despite the potential, only ~40% of users ever tried image search, and the ones who did use it weren't converting.",
    closingLine: "So our challenge became:",
    challengeHeading: "How can we improve the image search MVP to drive sales and grow adoption beyond 40%?",
    challengeAccent: "drive sales and grow adoption beyond 40%?",
    beforeImage: {
